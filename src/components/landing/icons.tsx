/**
 * Inline SVG icon set for the landing page. CLAUDE.md §13 bans icon
 * libraries — every glyph is a hand-rolled 24×24 stroke path inheriting
 * currentColor, sized by the caller via className.
 */
