        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-sm leading-relaxed" style={{ color: "#A0A0A0" }}>
              ...
              codes from third-party services. The Service is intended for
              legitimate verification use only — creating accounts, recovering
              passwords, and verifying identity with platforms that require SMS
              confirmation.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed" style={{ color: "#A0A0A0" }}>
              ...
              Payment is processed securely through Flutterwave. By topping up
              your wallet, you agree to the stated pricing and any applicable
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed" style={{ color: "#A0A0A0" }}>
              ...
              shall not exceed the amount you have paid to us in the preceding
              12 months.
            </p>
          </section>
