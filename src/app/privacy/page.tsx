        ...
        <div className="space-y-8">
          <section>
            ...
            >
              ...
              <li>
                <strong>Transaction history</strong> — records of wallet
                top-ups, order costs, and refunds
              </li>
              <li>
                <strong>Order details</strong> — service type, country, phone
                number, and SMS codes received
              </li>
              <li>
                <strong>Usage data</strong> — basic analytics to improve the
                Service (page views, error logs)
              </li>
            </ul>
            <p
          ...
          <section>
            ...
            >
              ...
              <li>
                Providing phone numbers and delivering SMS verification codes
              </li>
          ...
          <section>
            ...
            >
              ...
              <li>
                <strong>Flutterwave</strong> — payment processing. Handles all
                wallet top-up transactions. We do not store your payment card
                details.{" "}
                <a
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed" style={{ color: "#A0A0A0" }}>
              ...
              systems within 30 days of receipt. You may request deletion of
